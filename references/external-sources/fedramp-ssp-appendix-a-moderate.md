# FedRAMP SSP Appendix A — Moderate Baseline Security Controls (Excerpt)

- **Source URL:** https://www.fedramp.gov/resources/templates/SSP-Appendix-A-Moderate-FedRAMP-Security-Controls.docx
- **Retrieved:** 2026-07-17
- **Why included:** Primary Federal cadence anchor for most control families in the research: MA-3 (annual maintenance-tool review), CM-2/CM-7/CM-8 (annual baseline, quarterly software list, monthly inventory), AU-6/AU-11 (weekly review, retention), RA-5/SI-2/SI-3 (monthly scanning, 30/90/180-day remediation, weekly/real-time malware scanning), CA-2/CA-5/CA-7/CA-8 (annual assessment, monthly POA&M, monthly scans, annual pen test), CP-2/CP-3/CP-4/CP-9 (annual CP review/testing, daily incremental/weekly full backups, annual backup test), IR-2/IR-3 (10/30-day initial training, annual functional testing), PE-2/PE-3/PE-6/PE-8 (annual access list, monthly log review), and AC-2/IA-4/IA-5/IA-11 (quarterly privileged/annual non-privileged review, session lifetime).

> **NOTE — THIS IS AN EXCERPT, NOT THE COMPLETE DOCUMENT.** The original is a ~500KB Microsoft Word (.docx) System Security Plan Appendix A template covering all FedRAMP Moderate-baseline controls with full control statement text, parameter assignments, and blank SSP response tables (implementation status, responsible role, control origination checkboxes, etc.). Only the control statement text and FedRAMP-assigned frequency/timing parameters for the control families cited in the JSIG cadence research (AC, AU, CA, CM, CP, IA, IR, MA, PE, RA, SI) are reproduced below, with SSP response-table boilerplate stripped out. For the complete document, including every control family, control enhancement, and blank customer-response worksheet, download the full .docx from the source URL above.
...
[FedRAMP Assignment: quarterly for privileged access, annually for
...
system [FedRAMP Assignment: functional, at least annually] using the
...
security personnel near-realtime] in response to malicious code
detection; and
...
*End of excerpt. Full source: https://www.fedramp.gov/resources/templates/SSP-Appendix-A-Moderate-FedRAMP-Security-Controls.docx*
