...
full, accurate extraction. See `references/JSIG-source/EXTRACTION-LOG.md` for
...
- All 18 Chapter 3 control families (AC, AT, AU, CA, CM, CP, IA, IR, MA, MP,
  ...
  and DoD SAP-specific supplemental guidance, in `references/JSIG-source/chapter-3-*-family.md`.
- All 8 Privacy chapter sub-families (AP, AR, DI, DM, IP, SE, TR, UL), in
  `references/JSIG-source/chapter-3-privacy-*-family.md`.
- Appendix A (References), B (Acronyms), C (SAP Security Control Baselines —
  ...
  `references/JSIG-source/appendix-*.md`.
...
- **Appendix D (Confidentiality Impact Level Flowchart)**: the flowchart is a
  ...
  `references/JSIG-source/appendix-d-confidentiality-impact-level-flowchart.md`
...
- **Minor Privacy-chapter title-text cosmetic artifact**: see the "Known
  limitation" note at the end of `references/JSIG-source/EXTRACTION-LOG.md`
