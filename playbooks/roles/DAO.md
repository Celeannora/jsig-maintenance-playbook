...
|---|---|---|---|
| Approve and monitor implementation of the POA&M (if delegated) | Monthly | CA-5 | [MAINTENANCE-PLAN §3.4 CA](../../MAINTENANCE-PLAN.md); [JSIG §1.5.6](../../references/JSIG-source/section-1.5-roles-and-responsibilities.md) |
...
| Receive ISSM/ISSO notification of changes/incidents that might affect authorization | Event-driven | CM-3, CM-4, IR-6 | [JSIG §1.5.15(j)](../../references/JSIG-source/section-1.5-roles-and-responsibilities.md); [MAINTENANCE-PLAN §3.5 CM](../../MAINTENANCE-PLAN.md) |
| Verify own delegated authority scope remains current against delegation letter (impact levels for C/I/A) | Annual, or upon delegation renewal | RA-2 (impact-level linkage) | [JSIG §1.5.6](../../references/JSIG-source/section-1.5-roles-and-responsibilities.md) |

## 4. Coordination Interfaces

- **Authorizing Official (AO):** acts on behalf of, and within limits set by, the AO's written delegation letter; escalates matters outside delegated authority ([JSIG §1.5.6](../../references/JSIG-source/section-1.5-roles-and-responsibilities.md)).
- **Security Control Assessor (SCA):** receives assessment results and recommendations for delegated systems ([JSIG §1.5.7](../../references/JSIG-source/section-1.5-roles-and-responsibilities.md)).
- **Information System Owner (ISO):** coordinates SSP/POA&M approval and authorization-package review for delegated systems ([JSIG §1.5.12](../../references/JSIG-source/section-1.5-roles-and-responsibilities.md)).
- **ISSM/ISSO:** receives change/incident notifications that might affect the authorization decision ([JSIG §1.5.14](../../references/JSIG-source/section-1.5-roles-and-responsibilities.md), [§1.5.15](../../references/JSIG-source/section-1.5-roles-and-responsibilities.md)).
- **AO's other DAOs / REF / CIO / CISO:** coordinates as needed for consistency across delegated authorization decisions ([JSIG §1.5.5(l)](../../references/JSIG-source/section-1.5-roles-and-responsibilities.md) applied by extension to delegated authority).
