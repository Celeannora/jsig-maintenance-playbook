...
TOOL_KEYWORD_RULES = [
    ...
    (r"backup|contingency|recovery|reconstitution", "Windows Server backup/recovery tooling (organization-specific)"),
...
def main():
    ...
    for old in os.listdir(OUT_DIR):
        if old.startswith("MRC-") and old.endswith(".md"):
    ...
    idx_lines = [
        ...
        f"Do not hand-edit individual cards -- edit a source file and regenerate.",
        "",
