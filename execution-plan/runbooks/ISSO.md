...
The ISSO is the operational-security-posture role defined in [JSIG §1.5.15](../../reference/JSIG-source/section-1.5-roles-and-responsibilities.md), sitting under the ISSM in day-to-day standing but assuming ISSM duties in the ISSM's absence, per [playbooks/roles/ISSO.md](../../playbooks/roles/ISSO.md). Executes 21 Master Calendar tasks directly, is Accountable for 17, Consulted on 53, Informed on 3 — see [execution-plan/RACI-MATRIX.md](../RACI-MATRIX.md) Part B for the full rollup.
...
- [reference/JSIG-source/section-1.5-roles-and-responsibilities.md § 1.5.15](../../reference/JSIG-source/section-1.5-roles-and-responsibilities.md)
